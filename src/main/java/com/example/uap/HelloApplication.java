...
public class HelloApplication extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        buttonPesan.setOnAction(e -> {
            ...
            try {
                ...
                Peringatan("Error: " + ex.getMessage());
            }
        });
        ...
        vbox.getChildren().addAll(labelNama, addNama, labelJumlahTiket, addJumlah,
    ...
    /**
     * Method untuk menghapus pesanan dari tabel dan file data.
